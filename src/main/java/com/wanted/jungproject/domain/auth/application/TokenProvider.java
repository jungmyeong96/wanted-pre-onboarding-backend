package com.wanted.jungproject.domain.auth.application;
...
//    private String secret;
    ...
    // application.properties에서 주입받은 secret 값을 base64 decode하여 key 변수에 할당
    ...
    public TokenInfoResponse generateTokenDto(UserDetails userDetails) {
        // 권한들 가져오기
